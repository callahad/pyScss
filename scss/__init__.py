...
from .colors import _colors, _reverse_colors, _short_color_re
from .config import LOAD_PATHS, STATIC_ROOT, VERBOSITY, DEBUG, log
...
from .regexes import (SEPARATOR, _collapse_properties_space_re, _colors_re,
                      _escape_chars_re, _expand_rules_space_re, _expr_glob_re,
                      _interpolate_re, _ml_comment_re, _nl_num_nl_re, _nl_re,
                      _prop_split_re, _reverse_colors_re, _skip_re,
                      _skip_word_re, _sl_comment_re, _spaces_re, _strings_re,
                      _variable_re, _zero_re, _zero_units_re)
from .support import (CODESTR, CONTEXT, DEPS, FILEID, FINAL, INDEX, LINENO,
                      MEDIA, OPTIONS, PATH, POSITION, PROPERTIES, RULE_VARS,
                      SELECTORS)
